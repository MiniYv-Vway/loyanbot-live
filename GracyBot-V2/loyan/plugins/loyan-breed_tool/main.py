...
from graci import on_command, plugin_handler, PluginContext, get_logger, LoyanImage, get_storage_dir

logger = get_logger("狗狗品种")
    ...
    try:
        ...
        if not breed:
            ...
            if url:
                ...
                temp_dir = os.path.join(get_storage_dir(), "data", "loyan-breed_tool")
