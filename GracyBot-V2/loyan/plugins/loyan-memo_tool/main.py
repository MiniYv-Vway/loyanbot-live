...
from graci import on_command, plugin_handler, PluginContext, get_logger, get_storage_dir

logger = get_logger("备忘录")

# ── 常量定义 ──
DATA_FILE = os.path.join(get_storage_dir(), "data", "loyan-memo_tool", "memo.json")
MAX_ITEMS = 50
