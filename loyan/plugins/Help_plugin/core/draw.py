...
class LoyanBotHelpDrawer:
    ...
    def _load_fonts(self) -> None:
        ...
        try:
            self.font_title = get_zh_font(36)
            self.font_subtitle = get_zh_font(18)
            self.font_plugin_header = get_zh_font(20)
            self.font_command = get_zh_font(15)
            self.font_desc = get_zh_font(13)
    ...
    def draw_help_image(self, plugin_commands_dict: Dict[str, Any]) -> bytes:
        ...
        # 底部版权
        footer_text = f"LoyanBot --致力于简洁体验的QQ框架"
